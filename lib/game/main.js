  ...
  window.StartScreen = window.BaseScreen.extend({
    ...
    update: function() {
      ...
      if (this.play.clicked()) {
        ...
        return ig.system.setGame(window.TutorialGame);
      }
    },
    draw: function() {
      var camera_x;
